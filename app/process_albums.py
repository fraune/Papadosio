...
def process_track_data(track_data):
    ...
    # Add calculated duration to the track data
    track_data["duration"] = total_duration
    track_data["itemListElement"] = cleaned_item_list
    return track_data
...
def filter_json(json_blob):
    ...
    if "track" in filtered_json:
        filtered_json["track"] = process_track_data(filtered_json["track"])
